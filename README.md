...
```
npm create cloudflare@latest -- --template=cloudflare/templates/green-base-2257
```

A live public deployment of this template is available at [https://green-base-2257.templates.workers.dev](https://green-base-2257.templates.workers.dev)
